...
<head>
	...
	<link rel="stylesheet" href="attach/css/perfil.css"/>
	...
	<div class="contenido">
		<aside class="info-contacto">
			<div class="info-grupo">
				...
				<p class="correo-contacto">pastoralirio6589@gmail.com</p>
			</div>
			<div class="info-grupo">
				<h3>Fecha de nacimiento</h3>
				<p class="naci-contacto">16, Septiembre del 2001</p>
			</div>
			<div class="info-grupo">
				<h3>Me gusta</h3>
				<p class="gustos-contacto">La programación, informática y el desarrollo web</p>
			</div>
		</aside>
